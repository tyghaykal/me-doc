...
<template>
  <div v-if="pagesStore.favoritePages.length">
    <p class="mb-1 px-2 text-xs font-semibold uppercase tracking-wide text-neutral-400 dark:text-neutral-500">Favorites</p>
    <ul class="text-sm text-neutral-700 dark:text-neutral-300">
      <li v-for="page in pagesStore.favoritePages" :key="page.id">
        <button
          type="button"
